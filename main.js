...
let html = <div style="margin-bottom:20px;">   <div style="background:${headerColor}; color:white; padding:8px; font-weight:bold; border-radius:5px 5px 0 0;">   ${type} List   </div>   <table style="width:100%; border-collapse:collapse; background:white;">   <tr style="background:#f1f1f1;">   <th style="padding:8px; border:1px solid #ddd;">${type} No</th>   <th style="padding:8px; border:1px solid #ddd;">SP</th>   <th style="padding:8px; border:1px solid #ddd;">Orifice</th>   <th style="padding:8px; border:1px solid #ddd;">Type</th>   </tr>;

data.forEach(item => {
html += <tr onclick="openModal('${item.psvNo}')" style="cursor:pointer;">   <td style="padding:8px; border:1px solid #ddd;">${item.psvNo}</td>   <td style="padding:8px; border:1px solid #ddd;">${formatPressure(item.sp)}</td>   <td style="padding:8px; border:1px solid #ddd;">${item.orifice}</td>   <td style="padding:8px; border:1px solid #ddd;">${item.type}</td>   </tr>;
});
